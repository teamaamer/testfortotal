    ...
    <div class="main-container">
        ...
        <section class="page-title page-title-2 image-bg overlay parallax">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="uppercase mb8">Maintenance</h2>
                    </div>
        ...
        <section class="bg-secondary" style="padding-bottom: 0%">
            <div class="container">
                <div class="row">

                    <div class="col-sm-12 text-center">
                        <h1 class="mb5 mb-xs-5">Smart Solutions</h1>

                        With years of hands-on experience in servicing and maintaining laser devices, we ensure your equipment operates at peak performance. Our team of skilled technicians specializes in preventive maintenance, calibration, and timely repairs, reducing downtime and extending the lifespan of your devices. We understand the precision and care that laser technology demands, and we bring a meticulous, professional approach to every service call. Trust us to keep your laser systems reliable, efficient, and ready for optimal performance.
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h3 class="color-primary">Submit your Maintenance Request</h3>

                        <div class="feature bordered text-center">
                         <form class="text-left contactForm" method="POST" action="{{ route('contact.maintenance') }}">
