                    ...
                    <div class="row mb24 mb-xs-48">
                        <div class="col-md-5 col-sm-6">
                            <div class="image-slider slider-thumb-controls controls-inside">
                                <ul class="slides">
                                    <li>
                                        <img alt="Image" src="{{ asset('/uploads/courses/' . $course->image) }}" />
                                    </li>
                                </ul>
                            </div>
                            <!--end of image slider-->
                        ...
                        <div class="col-md-5 col-md-offset-1 col-sm-6">
                            <div class="description">
                                <h4 class="uppercase">{{ $course->title }}</h4>
                                <div class="mb32 mb-xs-24">
                                    <span class="number price">${{ $course->price }}</span>
                                </div>
                                <p>
                                    {{ $course->summary }}
                                </p>
                            ...
                            <div class="tabbed-content text-tabs">
                                <ul class="tabs">
                                    ...
                                    <li>
                                        ...
                                        <div class="tab-content">
                                            <ul class="ratings" id="comments-list">
                                            ...
                                            <div class="text-center mt-3">
                                                <button id="load-more-comments" class="btn btn-light btn-sm"
                                            ...
                                            <form class="ratings-form">
                                                ...
                                                <textarea placeholder="Comment" id="comment-text" rows="3"></textarea>
